...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('ヘルプデスク')" class="grid">
                <flux:navlist.item icon="home" :href="route('dashboard')" :current="request()->routeIs('dashboard')"
                    wire:navigate>ダッシュボード</flux:navlist.item>
                <flux:navlist.item icon="question-mark-circle" :href="route('faqs.index')"
                    :current="request()->routeIs('faqs.*')" wire:navigate>FAQ管理</flux:navlist.item>
                <flux:navlist.item icon="envelope" :href="route('inquiries.index')"
